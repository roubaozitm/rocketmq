...
public class DefaultMQProducer extends ClientConfig implements MQProducer {
     ...
     * reference: https://cloud.tencent.com/developer/article/1480465
     */
    ...
    /**
     * 消息发送，指定消息选择算法，覆盖消息生产者默认的消息队列负载，带有超时时间
    ...
    /**
     * 消息异步发送，指定消息选择算法，覆盖消息生产者默认的消息队列负载
    ...
    /**
     * 消息异步发送，指定消息选择算法，覆盖消息生产者默认的消息队列负载，带有超时时间
    ...
    /**
     * 单向方式发送消息，指定消息选择算法，覆盖消息生产者默认的消息队列负载
