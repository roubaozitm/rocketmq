...
public class DefaultMQProducerImpl implements MQProducerInner {
    ...
    /**
     * defaultMQProducer实现类的启动方法
     * @param startFactory 是否启用factory
    ...
    public void start(final boolean startFactory) throws MQClientException {
        ...
        switch (this.serviceState) {
            ...
            case CREATE_JUST:
                ...
                // 通过client工厂创建一个client实例
                this.mQClientFactory = MQClientManager.getInstance().getAndCreateMQClientInstance(this.defaultMQProducer, rpcHook);

                // 在client实例的producerTable中，注册生产者组和defaultMQProducer实例
    ...
    public void checkTransactionState(final String addr, final MessageExt msg,
        ...
        Runnable request = new Runnable() {
            ...
            public void run() {
                ...
                // 获取transactionListener，检查本地事务状态
    ...
    private SendResult sendKernelImpl(final Message msg,
        ...
        // 若未找到队列所在的Broker地址，需要重新获取路由信息，再找一次
        if (null == brokerAddr) {
        ...
        if (brokerAddr != null) {
            ...
            try {
                ...
                // 查看消息是否是事务消息，若是则设置消息标志位
                final String tranMsg = msg.getProperty(MessageConst.PROPERTY_TRANSACTION_PREPARED);
                if (tranMsg != null && Boolean.parseBoolean(tranMsg)) {
                    sysFlag |= MessageSysFlag.TRANSACTION_PREPARED_TYPE;
                }

                // 设置CheckForbiddenContext上下文，执行CheckForbidden钩子
                ...
                switch (communicationMode) {
                    ...
                    case ASYNC:
                        ...
                        // 恢复msgBody的原始topic名（防止重发的时候又加一遍？）
    ...
    /**
     * 发送事务的提交/回滚消息
     * @param sendResult            发送消息的结果
     * @param localTransactionState 本地事务的结果
